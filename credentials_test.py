...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credentials('Abdiaziz','Twitter','1234')
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.user_name,"Abdiaziz")
    ...
    def test_delete_credentials(self):
        ...
        '''
        self.new_credential.save_credentials()
        test_credential = Credentials("Abdiaziz","Twitter","1234") # new credential
